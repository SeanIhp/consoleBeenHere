package cn.com.beenhere.core.controller;
...
import cn.com.beenhere.common.consts.IhpConfig;
import cn.com.beenhere.common.underware.DataValidator;
import cn.com.beenhere.common.underware.secure.Md5;
import cn.com.beenhere.common.underware.secure.Sha256;
import cn.com.beenhere.common.utils.DateTime;
import cn.com.beenhere.common.utils.ID;
import cn.com.beenhere.core.entify.ResultObject;
import cn.com.beenhere.core.service.AccountService;
...
public class AccountController {
	...
	public @ResponseBody ResultObject regist(@RequestBody Account account){
		...
		try {
			...
			account.setTheType(100);
			account.setPhoneNumber("4008000000");
			account.setScore(0L);
			account.setActScore(0L);
